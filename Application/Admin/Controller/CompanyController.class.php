...
class CompanyController extends BackendController{
    ...
    public function edit_company(){
        ...
        else //保存企业信息
        {
            ...
            if (C('qscms_company_repeat')=="0")
            {
                ...
                if($info) $this->error("{$setsqlarr['companyname']}已经存在，同公司信息不能重复注册");
            }
    ...
    public function img(){
        ...
        $this->assign('count',parent::_pending('CompanyImg',array('company_id'=>$id,'audit'=>2)));
        parent::_list(D('CompanyImg'),$map,$order_by,'*','',array(),16);
        $this->display();
    }
