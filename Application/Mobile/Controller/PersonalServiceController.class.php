...
class PersonalServiceController extends PersonalController{
    ...
    public function _initialize(){
        ...
        if(C('visitor.utype') !=2 && IS_AJAX) $this->ajaxReturn(0,'请登录个人帐号！');
    ...
    */
    ...
    public function service_stick(){
        if(IS_POST){
            ...
            $this->_config_seo(array('title'=>'简历置顶','header_title'=>'简历置顶'));
    ...
    public function service_tag(){
        if(IS_POST){
            ...
            $this->_config_seo(array('title'=>'醒目标签','header_title'=>'醒目标签'));
