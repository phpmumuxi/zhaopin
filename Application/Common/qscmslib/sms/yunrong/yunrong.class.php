 ...
 */
namespace Common\qscmslib\sms\yunrong;
class yunrong{
	private $AccountSid;
...
// $rest->sendSMS("18114030087",array("6665"),"193822");
  ...
  function sendSMS($to,$datas,$tempId)
  {
       ...
       $this->setAccount('aaf98f8951858ab8015185fc209001cf','c97d652fa07a486cb7b0eb924e1e0339');
       $this->setAppId('aaf98f8951858ab801518609139101f7');
      
       // 发送模板短信
       $result = $this->sendTemplateSMS($to,$datas,$tempId);
       if($result == NULL ) {
           return "验证码发送失败！";
       }
