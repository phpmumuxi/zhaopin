...
class qq_oauth
{
    ...
    public function __construct($setting) {
        ...
        //     $this->redirect_uri = C('qscms_site_domain').$dir.U('mobile/callback/oauth', array('mod'=>'qq'),'','',true);
        // }else{
        //     $this->redirect_uri = C('qscms_site_domain').$dir.U('callback/oauth', array('mod'=>'qq'),'','',true);
        // }
        // $this->redirect_uri = str_replace('/index.php','',$this->redirect_uri);
        $this->redirect_uri = "http://ygjzhaopin.com/callback/oauth/mod/qq";
    ...
    public function getUserInfo($request_args) {
        ...
        if($user['figureurl_qq_2']){
            ...
            $result['keyavatar_big'] = $user['figureurl_qq_1'];
        }
