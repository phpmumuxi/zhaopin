...
class ResumeEducationModel extends Model{
	protected $_validate = array(
		array('pid,uid,startyear,startmonth,education','identicalNull','',0,'callback'),
	...
	*/
	public function add_resume_education($data,$user)
	{
		...
		//写入会员日志
		write_members_log($user,2018,$insert_id);
		$resume_mod = D('Resume');
	...
	*/
	public function save_resume_education($data,$user)
	{
		...
		//写入会员日志
		write_members_log($user,2019,$data['pid']);
