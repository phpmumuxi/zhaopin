...
1.绑定您的".C('qscms_site_name')."帐号，求职招聘更加方便，并实时接收提醒通知。<a href='".$this->get_url(U('mobile/Members/apilogin_binding',array('openid'=>addslashes($object->FromUserName))))."'>点此立即绑定</a>
